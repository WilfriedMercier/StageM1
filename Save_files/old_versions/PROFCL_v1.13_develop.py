...
def print_help():
    ...
    print("    --median=WORD")
    print("             Median option. Must either be y for trigering median separation or o for computing only median sepration. Option is not trigered by default.")
    print("    --minmemb=NUMBER")
    print("             Minimum member of galaxies in a cluster. Default value is 1.")
    print("    --minmax=NUMBER NUMBER")
    print("             Minimum and Maximum IDs for clusters to test. Default values are 0 1.")
    print("    -D, --datatype=WORD NUMBER NUMBER NUMBER NUMBER")
    print("             Data type to use. Arguments with this options are as follows: Letter for data type, cluster richness, cluster ellipticity, cluster PA and background. Default values are A 160, 0.5, 50, 20.")
    return
...
if __name__ == '__main__':
    ...
    optlist, args = getopt.getopt(sys.argv[2:], "ecbDv:m:M:r:t:d:o:n:", ['verb=', 'ver=', 'verbosity=', 'model=', 'mod=', 'meth=', 'method=', 'met=', 'datatype=', 'ofile=', 'minmax=',
                                 'RmaxoverVir=', 'Rmaxovervir=', 'rmaxoverVir=', 'rmaxovervir=', 'tol=', 'tolerance=', 'minmemb=', 'Minmemb=', 'mm=', 'dtype=', 'outputfile=', 'MinMax=',
                                 'minmem=', 'Minmem=', 'datadir=', 'ddir=', 'datadirectory=', 'Npoints=', 'npoints=', 'output=', 'median=', 'med=', 'tole=', 'Minmax=', 'minMax=', 'MINMAX='])
    ...
    test_flag, median_flag, do_center, do_background, id_cluster_min_max, Npoints                             = "A", "n", "n", "n", "0 1", 0
    cluster_richness, cluster_ellipticity, cluster_PA, background                                             = 160, 0.5, 50, 20
    output_file = "test.output"

    print("minmax ", id_cluster_min_max)
    print(optlist, args)
