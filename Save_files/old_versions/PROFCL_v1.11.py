...
if __name__ == '__main__':
    ...
    #output_file = 'PROFCL_debug_montecarlo.output'
    #output_file = 'PROFCL_debug_analytical.output'
    #output_file = 'PROFCL_320G_de_analytical.output'
    output_file = 'PROFCL_320G_lbb_analytical.output'
    debug_file = 'DEBUG/PROFCL.debug'
    fmt  = "{:19} {:5} {:40} {:12} {:.1e} {:d} {:d} {:d} {:5} {:8} {:8.4f} {:8.4f} {:10.3f} {:5.3f} {:3.0f} {:6.2f} {:6.1f} {:15.7G} {:15.7G} {:5d} {:8.3f}"
    ...
    if 'median_flag' in locals():
        median_flag = input("Do you want to perform median separation method [%s]: " %median_flag) or median_flag
    else:
    ...
    for id_cluster in range(id_cluster_min,id_cluster_max+1):
            ...
            for ellipticity_flag in ellipticity_flags:
                ...
                for background_flag in background_flags:
                    ...
                    for model in models:
                        ...
                        print (" date/time          cluID/file              method      tol c e b int model    RA0       Dec0    log_r_{-2} ellip  PA log_bg   -lnL       BIC      Npasses     Computation_time(s)")
                        ...
                        print (fmt.format(
                            ...
                            fit_results.fun, BIC, fit_results.nfev, time_taken)
                        )
        ...
        if median_flag =="y":
            ...
            print        (fmt.format(date_time,version,galaxy_file,"median-sep",0,0,0,0,'x',"none",RA_cen_init0,Dec_cen_init0,log_median_separation,0,0,log_background_best_fit,0,0,0,0,0))
            f_out.write (fmt2.format(date_time,version,galaxy_file,"median-sep",0,0,0,0,'x',"none",RA_cen_init0,Dec_cen_init0,log_median_separation,0,0,log_background_best_fit,0,0,0,0,0))
