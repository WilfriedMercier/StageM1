...
def ProjectedNumber_tilde_ellip_NFW(X,ellipticity):
    ...
    if N_points == 0:
        ...
        Nprojtilde = 10**lNprojtilde / (1 - ellipticity)
    else:
...
def PROFCL_prob_uv(u, v, R_min, R_max, scale_radius, elliipticity, background, model):
    ...
    numerator = Nofa / (np.pi * a*a * bova ) * R_circ * SurfaceDensity_tilde(R_circ/a,model) + R_tmp * background
